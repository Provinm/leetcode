...
class Solution(object):
    def hammingWeight(self, n):
        ...
        return reverse_str.count("1")


'''
Runtime: 12 ms, faster than 95.99% of Python online submissions for Number of 1 Bits.
Memory Usage: 11.9 MB, less than 7.09% of Python online submissions for Number of 1 Bits.
